...
func TestOverviewDoesNotLoadManagerAssetsInitially(t *testing.T) {
	...
	for path, script := range map[string]string{
		...
		"settings-panel": "/static/js-deps/choices.min.js,/static/js/revisions.js,/static/js/schema-form.js,/static/js/settings.page.js?v=5,/static/js/mqtt.page.js?v=2,/static/js/tailscale.page.js?v=1,/static/js/systemconfig.page.js?v=2",
	...
	if !strings.Contains(body, `data-panel-css="/static/css/choices.min.css,/static/css/choices.css?v=1,/static/css/manager.css?v=18,/static/css/settings-controls.css?v=2"`) {
...
func TestOverviewPrefixesEveryURLBehindAForwardedPrefix(t *testing.T) {
	...
	for _, marker := range []string{
		...
		`data-panel-css="/node/static/css/choices.min.css,/node/static/css/choices.css?v=1,/node/static/css/manager.css?v=18,/node/static/css/settings-controls.css?v=2"`,
	} {
		if !strings.Contains(body, marker) {
