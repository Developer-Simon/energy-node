...
func TestOverviewDoesNotLoadManagerAssetsInitially(t *testing.T) {
	...
	if !strings.Contains(body, `data-panel-css="/static/css/choices.min.css,/static/css/choices.css?v=1,/static/css/manager.css?v=16"`) {
...
func TestOverviewPrefixesEveryURLBehindAForwardedPrefix(t *testing.T) {
	...
	for _, marker := range []string{
		...
		`href="/node/static/css/base.css?v=17"`,
		...
		`data-panel-css="/node/static/css/choices.min.css,/node/static/css/choices.css?v=1,/node/static/css/manager.css?v=16"`,
	} {
		if !strings.Contains(body, marker) {
