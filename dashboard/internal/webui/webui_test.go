...
func TestOverviewDoesNotLoadManagerAssetsInitially(t *testing.T) {
	...
	if !strings.Contains(body, `data-panel-css="/static/css/choices.min.css,/static/css/choices.css?v=2,/static/css/manager.css?v=22,/static/css/settings-controls.css?v=6"`) {
...
func TestOverviewPrefixesEveryURLBehindAForwardedPrefix(t *testing.T) {
	...
	for _, marker := range []string{
		...
		`data-panel-css="/node/static/css/choices.min.css,/node/static/css/choices.css?v=2,/node/static/css/manager.css?v=22,/node/static/css/settings-controls.css?v=6"`,
	} {
		if !strings.Contains(body, marker) {
